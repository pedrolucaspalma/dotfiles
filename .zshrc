...
alias svim="cd ~/Developer/dotfiles-e-scripts/ && git pull && cp ~/.config/nvim . && git commit -a -m 'upd neovim folder' && git push"
...
alias udot="cd ~/Developer/dotfiles-e-scripts/ && git pull && cp ./.zshrc ~ && cp -r ./nvim ~/.config/nvim"
